...
- Owner member, order and event records share one bounded, versioned route timeline whether opened from a workspace or a protected link. Back/Forward and scene restoration preserve the exact record, while an account identity guard clears protected route state before another administrator can inherit it.
