...
insert into public.events (name, category, event_date, end_date, location, region, sort_order) values
  ...
  ('Cricket Season Begins',                  'sport',      '2026-10-01', null,         'South East Queensland', 'South East Queensland', 13),
  ('AP&ES Games',                            'games',      '2026-10-11', '2026-10-12', 'South East Queensland', 'South East Queensland', 14),
  ('Blackall 100',                           'ultra',      '2026-10-17', null,         'Blackall Range',        'South East Queensland', 15),
  ...
  ('Cricket Season',                         'sport',      '2026-12-01', null,         'South East Queensland', 'South East Queensland', 19),
  ('XERT Team Competition',                  'xert',       '2026-12-05', null,         'Kingaroy',              'South East Queensland', 20)
