...
import { ADMIN_BUTTON } from '@/components/admin/ui';
...
export default function AdminRoute({ children }) {
  ...
  if (profileError && !isAdmin) {
    return (
      <div className="min-h-[100dvh] flex items-center justify-center px-6 pb-[max(1.5rem,env(safe-area-inset-bottom))] pt-[max(1.5rem,env(safe-area-inset-top))] bg-xert-navy" >
        <div className="max-w-md text-center" role="alert">
          <p className="font-display text-3xl uppercase text-xert-offwhite mb-3">Couldn&rsquo;t verify owner access</p>
          <p className="font-body text-base leading-relaxed mb-8 text-xert-pale/70" >
          ...
          <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-center gap-3">
            <button onClick={signOut}
              className="min-h-12 px-6 py-3 font-display text-base uppercase tracking-wide border border-xert-steel/35 text-xert-pale"
>
              Sign Out
            </button>
    ...
    return (
      <div className="min-h-[100dvh] flex items-center justify-center px-6 pb-[max(1.5rem,env(safe-area-inset-bottom))] pt-[max(1.5rem,env(safe-area-inset-top))] bg-xert-navy" >
        <div className="max-w-md text-center">
          ...
          <p className="font-body text-sm leading-relaxed mb-8 text-xert-pale/60" >
...
>
            ...
            <button onClick={signOut}
              className="px-6 py-3 font-display text-base uppercase tracking-wide border border-xert-steel/35 text-xert-pale"
>
              Sign Out
            </button>
          </div>
