...
const STATUS_COLORS = {
  ...
  contacted: 'bg-status-info-900/30 text-status-info-400',
  warm: 'bg-status-attention-900/30 text-status-attention-400',
  hot: 'bg-status-caution-900/30 text-xert-orange',
  foundation_offer_sent: 'bg-category-specialty-900/30 text-category-specialty-400',
  booked_trial: 'bg-status-confirmed-900/30 text-status-confirmed-400',
  joined: 'bg-status-confirmed-700/30 text-status-confirmed-300',
  // Training casually rather than joining is still a win, just a different one.
  casual: 'bg-category-recovery-900/30 text-category-recovery-300',
  reviewing: 'bg-status-info-900/30 text-status-info-400',
  interview: 'bg-category-specialty-900/30 text-category-specialty-400',
  shortlisted: 'bg-status-attention-900/30 text-status-attention-400',
  hired: 'bg-status-confirmed-700/30 text-status-confirmed-300',
  meeting: 'bg-category-specialty-900/30 text-category-specialty-400',
  approved: 'bg-status-confirmed-700/30 text-status-confirmed-300',
